...
const TableName = ({ tableData }: IEventProps) => {
  return (
    <>
      <table className='w-full whitespace-nowrap'>
        <tbody>
          {tableData.eventData.map((event: IEvents) => (
            <tr
              key={event._id}
              tabIndex={0}
              ...
              <td>
                <div>
                  {/* <Menu as="div" className="relative inline-block text-left">
                    <div>
                      <Menu.Button className="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">
...
const Table = ({ tableData }: IRealTimeEvents) => {
